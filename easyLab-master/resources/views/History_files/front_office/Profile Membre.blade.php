      ...
      <section class="breadcrumb-classic context-dark">
         <div class="swiper-container swiper-slider swiper-slider-3 swiper-container-horizontal swiper-container-true" data-height="2vh" data-loop="false" data-dragable="false" data-min-height="280px" data-slide-effect="true" style="height: 667px;">
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
              <div class="swiper-slide swiper-slide-active" data-slide-bg="img/AllFaculty2016-17.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-01-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
        ...
        <section class="section-70 section-md-114">
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-sm-4 text-sm-left">
                <div class="inset-sm-right-30"><img class="img-responsive reveal-inline-block" src="img/membre.jpg" width="340" height="340" alt="">
          ...
          <h6 class="text-bold">Les Encadreures</h6>
            ...
            <div class="col-sm-6 col-lg-1-1">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="584" height="500" alt="">
            ...
            <div class="col-sm-3 col-lg-1-1">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="images\projet.jpg" width="584" height="500" alt="">
                <div class="team-member-body">
                  <div>
            ...
            <div class="col-sm-3 col-lg-1-1">
             ...
             <div class="row row-lg-condensed">
            <div class="col-sm-3 col-lg-1-1">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="images\projet.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
