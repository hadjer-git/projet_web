          ...
          <div class="shell">
            <div class="range">
              <div class="cell-sm-4 cell-sm-push-2 text-sm-left">
                <div class="inset-sm-left-30"><img class="img-responsive reveal-inline-block img-rounded" src="{{asset('labo/front_office/History_files/user-christopher-smith-340x300.jpg')}}" width="340" height="300" alt="">
