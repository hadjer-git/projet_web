  ...
  <body>
    ...
    <div class="page text-center">
              ...
              <div class="rd-navbar-menu-wrap clearfix">
                ...
                <div class="rd-navbar-brand"><a class="reveal-inline-block" href="Home.html">
                    <div class="unit unit-xs-middle unit-lg unit-lg-horizontal unit-spacing-xxs">
                      <div class="unit-left">
                        <div class="wrap"><img width="170" height="172" src="img/1525711039.png" alt="">
                        </div>
                      </div>
                      <div class="unit-body text-lg-left">
                        <div class="rd-navbar-brand-title"><img width="170" height="172" src="img/1525711333.png" alt=""></div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <div class="rd-navbar-mobile-header-wrap">
                      <!--Navbar Brand Mobile-->
                      <div class="rd-navbar-mobile-brand"><a href="Home.html"><img width="136" height="138" src="img/1525711039.png" alt=""></a></div>
                    </div>
                    <!-- RD Navbar Nav-->
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a>Equipes</a>
                        <ul class="rd-navbar-dropdown" >
                          <li><a href="equipeGL.html">SIDK</a>
                          </li>
                          <li><a href="#">RSDS</a>
                          </li>
                          <li><a href="#">ILS</a>
      ...
      <main class="page-content">
        <section>
          ...
          <div class="swiper-container swiper-slider swiper-slider-3 swiper-container-horizontal swiper-container-true" data-height="100vh" data-loop="false" data-dragable="false" data-min-height="480px" data-slide-effect="true" style="height: 667px;">
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
              <div class="swiper-slide swiper-slide-active" data-slide-bg="img/home3.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-01-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
              ...
              <div class="swiper-slide swiper-slide-next" data-slide-bg="img/data-entry-services-a-boon-corporates.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-02-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
                <div class="swiper-slide-caption header-transparent-slide-caption">
                  <div class="container">
              ...
              <div class="swiper-slide" data-slide-bg="img/home2.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-03-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
                <div class="swiper-slide-caption header-transparent-slide-caption">
                  <div class="container">
            ...
            <div class="range text-sm-left range-sm-justify">
              <div class="cell-sm-7 view-animate fadeInRightSm delay-04">
                <div class="img-wrap-2">
                  <figure><span class="icon mdi mdi-play-circle-outline" data-toggle="modal" data-target="#myModal"></span><img class="img-responsive reveal-inline-block" src="img/apropos.jpg" width="620" height="350" alt=""></figure>
                </div>
              </div>
          ...
          <div class="shell">
            ...
            <div class="range offset-top-60 text-left range-xs-center">
              <div class="cell-sm-6 cell-md-4">
                <article class="post-news post-news-mod-1 view-animate fadeInLeftSm delay-04"><a href=""><img class="img-responsive img-fullwidth" src="./Home_files/news-01-370x240.jpg" width="370" height="240" alt=""></a>
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30 offset-sm-top-0">
                <article class="post-news post-news-mod-1 view-animate fadeInLeftSm delay-06"><a href=""><img class="img-responsive img-fullwidth" src="./Home_files/news-04-370x240.jpg" width="370" height="240" alt=""></a>
                  <div class="post-news-body">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30 offset-md-top-0">
                <article class="post-news post-news-mod-1 view-animate fadeInLeftSm delay-08"><a href=""><img class="img-responsive img-fullwidth" src="./Home_files/news-02-370x240.jpg" width="370" height="240" alt=""></a>
                  <div class="post-news-body">
        ...
        <!-- Testimonials-->
        <section class="context-dark parallax-container position-relative" data-parallax-img="images/parallax-03.jpg">
        ...
        <div class="shell section-60 section-bottom-20">
          <div class="range range-xs-center">
            <div class="cell-md-3 cell-lg-2">
              <!--Footer brand--><a class="reveal-inline-block view-animate zoomInSmall delay-06" href="https://livedemo00.template-help.com/wt_prod-14585/index.html"><img width="65" height="65" src="img/1525711039.png" alt="">
                <div>
