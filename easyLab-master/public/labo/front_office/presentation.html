      ...
      <section class="breadcrumb-classic context-dark">
         <div class="swiper-container swiper-slider swiper-slider-3 swiper-container-horizontal swiper-container-true" data-height="2vh" data-loop="false" data-dragable="false" data-min-height="280px" data-slide-effect="true" style="height: 667px;">
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
              <div class="swiper-slide swiper-slide-active" data-slide-bg="img/adacore-projet-hi-lite.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-01-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
      ...
      <main class="page-content">
          ...
          <div class="shell">
            <div class="range">
              <div class="cell-sm-4 cell-sm-push-2 text-sm-left">
                <div class="inset-sm-left-30"><img class="img-responsive reveal-inline-block img-rounded" src="./History_files/user-christopher-smith-340x300.jpg" width="340" height="300" alt="">
                  <div class="offset-top-20">
                    <h6 class="text-primary text-bold">Christopher Smith</h6>
                  </div>
                  <p>First president of the Modern University, served from 1876 to 1897.</p>
                </div>
              </div>
        ...
        <section>
          <div class="shell-wide">
            <div class="range">
              <div class="cell-sm-4"><img class="img-responsive reveal-inline-block" src="./History_files/history-01-570x370.jpg" width="570" height="370" alt=""></div>
              <div class="cell-sm-4"><img class="img-responsive reveal-inline-block" src="./History_files/history-02-570x370.jpg" width="570" height="370" alt=""></div>
              <div class="cell-sm-4"><img class="img-responsive reveal-inline-block" src="./History_files/history-03-570x370.jpg" width="570" height="370" alt=""></div>
            </div>
          </div>
        </section>
        <!--A Meeting of Minds-->
        ...
        <div class="shell section-60">
          <div class="range range-lg-justify range-xs-center">
            <div class="cell-md-3 cell-lg-2">
              <!--Footer brand--><a class="reveal-inline-block" href="https://livedemo00.template-help.com/wt_prod-14585/index.html"><img width="170" height="172" src="img/1525711039.png" alt="">
                <div>
                  <h6 class="barnd-name text-bold offset-top-25">LRIT</h6>
                </div>
                <div>
            ...
            <div class="cell-xs-10 cell-md-5 cell-lg-4 text-lg-left offset-top-50 offset-md-top-0">
                ...
                <ul class="list-unstyled contact-info list">
                  ...
                  <li class="offset-top-15">
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body text-left"><a class="text-dark" href="https://livedemo00.template-help.com/wt_prod-14585/history.html#">2130 Fulton Street San Diego, CA 94117-1080 USA</a></div>
                    </div>
                  </li>
                  <li class="offset-top-15">
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
              ...
              <div class="offset-top-15 text-left">
                <ul class="list-inline list-inline-xs list-inline-madison">
                  <li><a class="icon icon-xxs fa-facebook icon-circle icon-gray-light-filled" href="https://livedemo00.template-help.com/wt_prod-14585/history.html#"></a></li>
                  <li><a class="icon icon-xxs fa-twitter icon-circle icon-gray-light-filled" href="https://livedemo00.template-help.com/wt_prod-14585/history.html#"></a></li>
                  <li><a class="icon icon-xxs fa-google icon-circle icon-gray-light-filled" href="https://livedemo00.template-help.com/wt_prod-14585/history.html#"></a></li>
                  <li><a class="icon icon-xxs fa-instagram icon-circle icon-gray-light-filled" href="https://livedemo00.template-help.com/wt_prod-14585/history.html#"></a></li>
                </ul>
              </div>
            </div>
                      ...
                      <form class="rd-mailform form-subscribe" data-form-output="form-subscribe-footer" data-form-type="subscribe" method="post" action="https://livedemo00.template-help.com/wt_prod-14585/bat/rd-mailform.php" novalidate="novalidate">
                        <div class="form-group">
                          <div class="input-group input-group-sm">
                            <input class="form-control form-control-has-validation" placeholder="Your e-mail" type="email" name="email" data-constraints="@Required @Email" id="regula-generated-60899"><span class="form-validation"></span><span class="input-group-btn">
