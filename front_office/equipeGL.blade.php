                      ...
                      <div class="cell-md-3 offset-top-0">
                        ...
                        <div class="rd-navbar-brand"><a class="reveal-block" href="index.html">
                            <div class="unit unit-xs-middle unit-spacing-xxs">
                              <div class="unit-left"><img width='170' height='172' src='img/1525711039.png' alt=''/>
                              </div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <div class="rd-navbar-mobile-header-wrap">
                      <!--Navbar Brand Mobile-->
                      <div class="rd-navbar-mobile-brand"><a href="Home.html"><img width="136" height="138" src="img/dspace-logo-only.png" alt=""></a></div>
                    </div>
                    <!-- RD Navbar Nav-->
                    <ul class="rd-navbar-nav">
                      <li ><a href="Home.html">Accueil</a>
                      </li>
                      <li class="active"><a href="presentation.html">Presentation</a>
                      </li>
                      <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a>Equipes</a>
                        <ul class="rd-navbar-dropdown" >
                          <li><a href="equipeGl.html">GL</a>
                          </li>
      ...
      <section class="breadcrumb-classic context-dark">
         <div class="swiper-container swiper-slider swiper-slider-3 swiper-container-horizontal swiper-container-true" data-height="2vh" data-loop="false" data-dragable="false" data-min-height="280px" data-slide-effect="true" style="height: 667px;">
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
              <div class="swiper-slide swiper-slide-active" data-slide-bg="images/syteme_reseau_intro-1.jpg" style="background-position: 80% center; background-image: url(&quot;images/slide-01-1920x1000.jpg&quot;); background-size: cover; width: 1307px;">
            ...
            <div class="responsive-tabs responsive-tabs-classic vertical" data-type="vertical">
				...
				<div>
                  <div class="inset-lg-left-60">
                    ...
                    <div class="offset-top-30">
                     <img class="img-responsive reveal-inline-block" src="images/gl.jpg" width="770" height="480" alt=""></div>
              ...
              <div class="offset-top-60">
                <div class="rd-search-results"></div>
                      ...
                      <br>
                     <div align="center"> 
                      <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="500" height="100" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="Profile Membre.html">Membre1</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div><br><h3 class="text-bold veil reveal-lg-block"><a href="">Le Chef De L'équipe</a></h3></div>
                    </div>
...
<li>
            ...
            <div class="col-sm-2 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre1</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
             ...
             <div class="row row-lg-condensed">
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre2</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre3</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre5</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre6</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre7</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre8</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="Profile Membre.html">Profile</a>
                </div>
              </div>
          ...
          <li>
            ...
            <div class="col-sm-4 col-lg-1-5">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre9</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Profile</a>
                </div>
              </div>
            </div>
            <div class="col-sm-4 col-lg-1-5 offset-top-50 offset-sm-top-0">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre10</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5 offset-top-50 offset-sm-top-0">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre11</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Profile</a>
                </div>
              </div>
            ...
            <div class="col-sm-4 col-lg-1-5 offset-top-50 offset-lg-top-0">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre12</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Profile</a>
                </div>
              </div>
          ...
          <li>
            ...
            <div class="col-sm-4 col-lg-1-5 offset-top-50 offset-lg-top-0">
              <div class="team-member"><img class="img-responsive reveal-inline-block" src="img/Membre.jpg" width="384" height="500" alt="">
                <div class="team-member-body">
                  <div>
                    <h4 class="text-bold team-member-title"><a href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Membre13</a></h4>
                  </div>
                  <p class="offset-top-0">specialité</p><a class="btn btn-primary" href="https://livedemo00.template-help.com/wt_prod-14585/team-member-profile.html">Profile</a>
                </div>
              </div>
                    ...
                    <div class="offset-top-30">
                      ...
                      <div class="offset-top-20">
                        <ul class="list list-unstyled list-marked">
                           <li><a href="projet.html">Projet1</a></li>
                            <li><a href="projet.html">Projet1</a></li>
                            <li><a href="projet.html">Projet1</a></li>
                            <li><a href="projet.html">Projet1</a></li>
                            <li><a href="projet.html">Projet1</a></li>
        ...
        <section class="section-70 section-md-20 bg-catskilll">
                  ...
                  <div class="post-news-modern">
                    <div class="unit unit-sm unit-sm-horizontal unit-timeline unit-sm-inverse">
                      <div class="unit-body">
                        <article class="post-news post-news-wide"><a href="https://livedemo00.template-help.com/wt_prod-14585/news-post-page.html"><img class="img-responsive" src="./Modern News_files/news-01-770x500.jpg" width="770" height="500" alt=""></a>
                      ...
                      <div class="unit-right text-center">
                        <div class="unit unit-horizontal unit-middle unit-spacing-xxs unit-sm unit-sm-vertical unit-sm-inverse">
                          <div class="unit-left"><img class="img-responsive img-circle reveal-inline-block" src="./Modern News_files/user-maria-freeman-90x90.jpg" width="90" height="90" alt="">
                  ...
                  <div class="post-news-modern">
                    <div class="unit unit-sm unit-sm-horizontal unit-timeline unit-sm-inverse">
                      <div class="unit-body">
                        <article class="post-news post-news-wide"><a href="https://livedemo00.template-help.com/wt_prod-14585/news-post-page.html"><img class="img-responsive" src="./Modern News_files/news-06-770x500.jpg" width="770" height="500" alt=""></a>
                          <div class="post-news-body">
                      ...
                      <div class="unit-right text-center">
                        <div class="unit unit-horizontal unit-middle unit-spacing-xxs unit-sm unit-sm-vertical unit-sm-inverse">
                          <div class="unit-left"><img class="img-responsive img-circle reveal-inline-block" src="./Modern News_files/user-steven-alvarez-230x230.jpg" width="90" height="90" alt="">
                  ...
                  <div class="post-news-modern">
                    <div class="unit unit-sm unit-sm-horizontal unit-timeline unit-sm-inverse">
                      <div class="unit-body">
                        <article class="post-news post-news-wide"><a href="https://livedemo00.template-help.com/wt_prod-14585/news-post-page.html"><img class="img-responsive" src="./Modern News_files/news-03-770x500.jpg" width="770" height="500" alt=""></a>
                          <div class="post-news-body">
                  ...
                  <div class="post-news-modern">
                    <div class="unit unit-sm unit-sm-horizontal unit-timeline unit-sm-inverse">
                      <div class="unit-body">
                        <article class="post-news post-news-wide"><a href="https://livedemo00.template-help.com/wt_prod-14585/news-post-page.html"><img class="img-responsive" src="./Modern News_files/news-05-770x500.jpg" width="770" height="500" alt=""></a>
                          <div class="post-news-body">
		...
		<div id="titre"><h3>Les laboratoires partenaires</h3>
		 ...
		 <div class="colonne_deco"><div class="style_1">
								...
								<a href="paterne.html" ><strong>LA&nbsp;CONCEPTION, L'OPTIMISATION ET&nbsp;LA&nbsp;PRODUCTION</strong></a><div style="text-align: center;"><a  href="paterne.html" ><img title="" alt="" style="width:320px;height:140px;margin : 10px 0px;" src="http://genie-industriel.grenoble-inp.fr/medias/photo/logo-g-scop_1393325206311-jpg" /></a></div><div style="text-align: justify;">G-SCOP  tente de r&eacute;pondre aux d&eacute;fis scientifiques pos&eacute;s par les mutations du  monde industriel en cours et &agrave; venir. Le p&eacute;rim&egrave;tre du laboratoire va de  la conception des produits &agrave; la gestion des syst&egrave;mes de production en  s'appuyant sur de fortes comp&eacute;tences en optimisation.</div>
			...
			<div class="colonne_2">
				<div class="colonne_deco"><div class="style_1">
								...
								<a _linktype="interne" href="http://genie-industriel.grenoble-inp.fr/recherche/gael-583587.kjsp?RH=GI_FR-LABP" class="lien_interne"> <strong>LABORATOIRE&nbsp;D'&Eacute;CONOMIE APPLIQU&Eacute;E DE GRENOBLE </strong></a> &nbsp;<div style="text-align: center;"><a _linktype="interne" href="par_1.html" class="lien_interne"><img src="http://genie-industriel.grenoble-inp.fr/medias/photo/logo-gael-couleur-fr-sans-texte_1498221820842-jpg" alt="" title="" style="width:205px;height:140px;" /></a></div><div style="text-align: justify;"><br />GAEL est un laboratoire de l'INRA, de l'UGA et de Grenoble INP. Ce laboratoire conduit des recherches finalis&eacute;es en lien avec l'agriculture, la consommation et le d&eacute;veloppement durable.</div>
							</div><!-- .paragraphe__contenu--1 .toolbox -->
						</div><!-- paragraphe--1 --></div><!-- colonne_deco -->
        ...
        <div class="shell section-60">
          <div class="range range-lg-justify range-xs-center">
            <div class="cell-md-3 cell-lg-2">
              <!--Footer brand--><a class="reveal-inline-block" href="index.html"><img width='170' height='172' src='img/1525711039.png' alt=''/>
                <div>
